spool C:\Users\saksh\Documents\FoundationOfComputing\Project3TextFiles\analysis_2_min_per_year.txt
set echo on
set timing on
column column_name format a15
set linesize 200
--Analysis 2
--Actor & and Actress who did minimum movies in a particular year over the span of 10 years
(
    SELECT
        nb.nconst
        || ' ; '
        ...
        || COUNT(tb.titletype)
        || ' ; '
        || tp.category AS "ID ; Name ; Year ; MinMovieCount ; Category"
    FROM
